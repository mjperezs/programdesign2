/* Maria Jose Perez
    ...
    This program prompts the user to enter a supply and sorts the school supplies by name and color in the input file the matched supplies. 
    Then, it writes the results into a new output file.
...
int compare_supplies(const void *a, const void *b)
{
    ...
    if (cmp == 0)
    {
        //if names are the equal, compare by color
